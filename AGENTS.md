...
Codex sessions for this repository should run in full-auto mode:

- `approval_policy = "never"`
- `sandbox_mode = "workspace-write"`

This does not override the sudo boundary above; elevated host changes still require the user to run the provided command.
