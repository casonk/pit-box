...
#pb-clip-title { font-size: 16px; }
#pb-clip-help { color: #8b949e; font-size: 12px; }
#pb-clip-text {
  width: 100%;
  flex: 1 1 auto;
  min-height: 0;
...
INJECTED_HTML = """\
<div id="pb-stage"><div id="terminal-container"></div></div>
<div id="pb-toolbar">
  <div class="pb-row">
